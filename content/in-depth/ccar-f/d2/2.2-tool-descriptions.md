...
for. At the moment of choosing, it has **only the name, the description, and the input schema** — the declared shape of the
input, saying which fields exist, of what type, and which are required.
