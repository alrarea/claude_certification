...
- **The error flag** (`isError` on an **MCP** result — the Model Context Protocol, the standard
  way a server exposes tools to an AI client, covered in 2.1 — or `is_error` on a `tool_result`). The binary
