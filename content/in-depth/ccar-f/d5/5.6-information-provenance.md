...
the link from a claim to the source it came from was optional. That link is **provenance** — the
record of where a piece of information came from — and summarisation, which is lossy by design,
discarded it first, because provenance is metadata rather than "the point" of the text.
