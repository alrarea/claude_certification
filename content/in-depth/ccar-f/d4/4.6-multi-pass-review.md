...
Here **recall** means the share of the real problems the review actually catches, and **fan-out**
means splitting one job into many requests that run side by side.
