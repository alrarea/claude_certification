...
instruction. Define a tool with a JSON **schema** instead — a declaration of which fields exist,
of what type, and which are required — and the shape stops being a request: the API validates the
tool's input against your schema.
