...
An **SLA** — a service level agreement — is a promise about how a system will behave, written
down and contractually binding: how fast, how accurate, how available, at what price. Agreeing one
is an architectural act, whoever signs it.
...
A **circuit breaker** stops calling a failing dependency for a cool-off period rather than
retrying into it and making the outage worse.
