...
That gap is what RAG exists to close: retrieve the relevant passages from your own source and put
...
7. **Place retrieved chunks near the end**, immediately before the question, where recall is
   strongest.
