...
the noise floor on a pass rate is around ±7 points. The team spent six weeks shipping prompt
...
1. **Sample from real traffic**, stratified by category and weighted to the real distribution —
   not by popularity rank.
