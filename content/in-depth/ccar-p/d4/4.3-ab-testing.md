...
live traffic, showed a p95 latency increase (the slow tail, what 95% of requests come in under) of 1.9 seconds — the new structure produced longer
...
**Cause.** Differences smaller than the noise floor — the smallest gap the dataset can tell apart
from luck — reported as results.
